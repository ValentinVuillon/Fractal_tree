...
void draw_branches(PVector point, PVector vector, float angle, float ratio, float limit_branch_length){
  ...
  rotated_reduced_size_vector_1=rotate(reduced_size_vector, angle*1.6);
  rotated_reduced_size_vector_2=rotate(reduced_size_vector, -angle*1.7);
  rotated_reduced_size_vector_3=rotate(reduced_size_vector, angle*3);
  ...
  if(reduced_size_vector.mag()>limit_branch_length){
    ...
    draw_branches(new_point, rotated_reduced_size_vector_2, angle, ratio*0.7, limit_branch_length);
    draw_branches(new_point, rotated_reduced_size_vector_3, angle, ratio*0.5, limit_branch_length);
  }
